...
;;        ?pc#prime[p_1] = "U2" ,
;;        pc[p] # "FR" 
;; PROVE  (/\ (t.ret)[p_1] = BOT) /\ (t.op)[p_1] = "U"
...
;; Proof obligation #320
;;   generated from file "/Users/karunram/Desktop/TLAPS/jtunionfind/FRInv_Proof.tla", line 863, characters 9-10
      ...
      (forall ((a_tunde_1a u))
        (=>
          (and
            ...
            (= (tla__fcnapp pc a_punde_2a) (str2u string__a_U2a)))
          (and
            (ite
...
(assert
  (ite
    (= a_punde_1a p) false
    (= (tla__fcnapp pc a_punde_1a) (str2u string__a_U2a))))
