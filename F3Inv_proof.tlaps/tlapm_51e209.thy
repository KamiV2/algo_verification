...
theory tlapm_51e209 imports Constant Zenon begin
consts
  "isReal" :: c
  "isa_slas_a" :: "[c,c] => c"
  "isa_bksl_diva" :: "[c,c] => c"
...
lemma ob'586: (* 5c0eac76db8fe9b43853d58df49c9f5b *)
...
shows "((EdgeOK ((fapply ((a_ca), (a_punde_1a))), (fapply ((a_uunde_Fa), (a_punde_1a))))))"(is "PROP ?ob'586")
proof -
show "PROP ?ob'586"
using assms by auto
qed
