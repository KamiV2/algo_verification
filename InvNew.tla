...
InvU2All(p, t) ==   /\ SameRoot(t, arg[p][1], u_U[p])   
                    /\ SameRoot(t, arg[p][2], v_U[p])   


InvU5All(p, t) ==   /\ SameRoot(t, arg[p][1], u_U[p])   
                    /\ SameRoot(t, arg[p][2], v_U[p]) 
                    /\ u_U[p] # v_U[p]
                    /\ a_U[p].bit = 0 => SameRoot(t, a_U[p].parent, u_U[p])
                    /\ a_U[p].bit = 1 => t.sigma[u_U[p]] = u_U[p]

InvU6All(p, t) ==   /\ SameRoot(t, arg[p][1], u_U[p])   
                    /\ SameRoot(t, arg[p][2], v_U[p]) 
                    /\ u_U[p] # v_U[p]   
                    /\ a_U[p].bit = 0 => SameRoot(t, a_U[p].parent, u_U[p])
                    /\ a_U[p].bit = 1 => t.sigma[u_U[p]] = u_U[p]
...
InvU7All(p, t) ==   /\ SameRoot(t, arg[p][1], u_U[p])   
                    /\ SameRoot(t, arg[p][2], v_U[p]) 
                    /\ t.ret[p] = ACK => SameRoot(t, u_U[p], v_U[p])

InvU8All(p, t) ==   /\ SameRoot(t, arg[p][1], u_U[p])   
                    /\ SameRoot(t, arg[p][2], v_U[p]) 
                    /\ t.ret[p] = ACK => SameRoot(t, u_U[p], v_U[p])
...
\* Last modified Thu Apr 17 03:13:23 EDT 2025 by karunram
\* Created Thu Apr 17 02:36:30 EDT 2025 by karunram
