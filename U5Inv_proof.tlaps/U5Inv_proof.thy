...
assumes v'107: "(((fapply ((pc), (p))) = (''U5'')))"
assumes v'108: "((((a_pchash_primea :: c)) = ([(pc) EXCEPT ![(p)] = (''U6'')])))"
assumes v'109: "((((a_bunde_Uhash_primea :: c)) = ([(a_bunde_Ua) EXCEPT ![(p)] = (fapply ((F), (fapply ((a_vunde_Ua), (p)))))])))"
...
assumes v'116: "((((a_aunde_Uhash_primea :: c)) = (a_aunde_Ua)))"
...
(* BEGIN ZENON INPUT
;; file=U5Inv_proof.tlaps/tlapm_3caead.znn; PATH='/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/bin:/usr/local/lib/tlaps/bin'; zenon -p0 -x tla -oisar -max-time 1d "$file" >U5Inv_proof.tlaps/tlapm_3caead.znn.out
;; obligation #605
$hyp "v'104" Inv
$hyp "v'105" (\/ Next (= hbf6f3f86ac3e561c1ee154bb0de6ab
varlist))
$hyp "p_in" (TLA.in p PROCESSES)
$hyp "v'107" (= (TLA.fapply pc p) "U5")
$hyp "v'108" (= a_pchash_primea
(TLA.except pc p "U6"))
$hyp "v'109" (= a_bunde_Uhash_primea
(TLA.except a_bunde_Ua p (TLA.fapply F (TLA.fapply a_vunde_Ua p))))
...
a_vunde_Ua)
$hyp "v'116" (= a_aunde_Uhash_primea
a_aunde_Ua)
...
proof (rule zenon_nnpp)
 ...
 have z_He:"(a_pchash_primea=except(pc, p, ''U6''))" (is "_=?z_hec")
 ...
 using t_in by blast
 have zenon_L1_: "(''U6''=?z_hbi) ==> FALSE" (is "?z_hjb ==> FALSE")
 proof -
  assume z_Hjb:"?z_hjb" (is "?z_hbp=_")
  have z_Hjc: "(?z_hbp~=?z_hbi)"
 ...
 proof -
  ...
  next
   ...
   assume z_Hs:"?z_hs"
   have z_Hry: "?z_hry"
   by (rule zenon_domain_except_0 [of "(\<lambda>zenon_Vtka. (a_punde_1a \\in zenon_Vtka))" "pc" "p" "''U6''", OF z_Hsh])
   show FALSE
 ...
 proof (rule zenon_notand [OF z_Htk])
  ...
  show FALSE
  proof (rule zenon_fapplyexcept [of "(\<lambda>zenon_Vbe. (zenon_Vbe=?z_hbi))" "pc" "p" "''U6''" "a_punde_1a", OF z_Hvc])
   assume z_Hry:"(a_punde_1a \\in DOMAIN(pc))" (is "?z_hry")
   assume z_Hvl:"(p=a_punde_1a)"
   assume z_Hjb:"(''U6''=?z_hbi)" (is "?z_hbp=_")
   show FALSE
...
fixes p
assumes p_in : "(p \<in> (PROCESSES))"
assumes v'109: "(((fapply ((pc), (p))) = (''U5'')))"
assumes v'110: "((((a_pchash_primea :: c)) = ([(pc) EXCEPT ![(p)] = (''U6'')])))"
assumes v'111: "((((a_bunde_Uhash_primea :: c)) = ([(a_bunde_Ua) EXCEPT ![(p)] = (fapply ((F), (fapply ((a_vunde_Ua), (p)))))])))"
...
(* BEGIN ZENON INPUT
;; file=U5Inv_proof.tlaps/tlapm_9e7d43.znn; PATH='/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/bin:/usr/local/lib/tlaps/bin'; zenon -p0 -x tla -oisar -max-time 1d "$file" >U5Inv_proof.tlaps/tlapm_9e7d43.znn.out
;; obligation #677
$hyp "v'106" Inv
$hyp "v'107" (\/ Next (= hbf6f3f86ac3e561c1ee154bb0de6ab
varlist))
$hyp "p_in" (TLA.in p PROCESSES)
$hyp "v'109" (= (TLA.fapply pc p) "U5")
...
proof (rule zenon_nnpp)
 ...
 have z_He:"(a_pchash_primea=except(pc, p, ''U6''))" (is "_=?z_heb")
 using v'110 by blast
 have z_Hn:"(a_chash_primea=a_ca)"
 using v'119 by blast
 ...
 have z_Ht:"(t \\in a_Mhash_primea)" (is "?z_ht")
 using t_in by blast
 have zenon_L1_: "(''U6''=''FR'') ==> FALSE" (is "?z_hhg ==> FALSE")
 proof -
  assume z_Hhg:"?z_hhg" (is "?z_hbo=?z_hbi")
  have z_Hhh: "(?z_hbo~=?z_hbi)"
  by (simp only: zenon_sa_1 zenon_sa_2,
      ((rule zenon_sa_diff_2)+)?,
      (rule zenon_sa_diff_3, auto)?,
      (rule zenon_sa_diff_1, auto)?,
 ...
 proof -
  ...
  next
   ...
   assume z_Hs:"?z_hs"
   have z_Hmz: "?z_hmz"
   by (rule zenon_domain_except_0 [of "(\<lambda>zenon_Veja. (a_punde_1a \\in zenon_Veja))" "pc" "p" "''U6''", OF z_Hni])
   show FALSE
 ...
 proof (rule zenon_notand [OF z_Hok])
  ...
  proof (rule zenon_notand [OF z_Hol])
   ...
   proof (rule zenon_notand [OF z_Hom])
    ...
    by (rule subst [where P="(\<lambda>zenon_Vxvj. (?z_hju~=(zenon_Vxvj[a_punde_1a])))", OF z_Hh z_Hon])
    have z_Hos: "((?z_heb[a_punde_1a])=?z_hbi)" (is "?z_hot=_")
    by (rule subst [where P="(\<lambda>zenon_Vxuj. ((zenon_Vxuj[a_punde_1a])=?z_hbi))", OF z_He z_Hnz])
    ...
    by (rule subst [where P="(\<lambda>zenon_Vbwj. (zenon_Vbwj \\in FuncSet(PROCESSES, {''0'', ''F1'', ''F2'', ''F3'', ''F4'', ''F5'', ''F6'', ''F7'', ?z_hbi, ''U1'', ''U2'', ''U3'', ''U4'', ''U5'', ''U6'', ''U7'', ''U8'', ''UR'', ''F1U1'', ''F2U1'', ''F3U1'', ''F4U1'', ''F5U1'', ''F6U1'', ''F7U1'', ''F8U1'', ''FRU1'', ''F1U2'', ''F2U2'', ''F3U2'', ''F4U2'', ''F5U2'', ''F6U2'', ''F7U2'', ''F8U2'', ''FRU2'', ''F1U7'', ''F2U7'', ''F3U7'', ''F4U7'', ''F5U7'', ''F6U7'', ''F7U7'', ''F8U7'', ''FRU7'', ''F1U8'', ''F2U8'', ''F3U8'', ''F4U8'', ''F5U8'', ''F6U8'', ''F7U8'', ''F8U8'', ''FRU8''})))", OF z_He z_Hv])
    ...
    by (rule subst [where P="(\<lambda>zenon_Vquj. (t \\in zenon_Vquj))", OF z_Hp z_Ht])
    show FALSE
    proof (rule zenon_fapplyexcept [of "(\<lambda>zenon_Vha. (zenon_Vha=?z_hbi))" "pc" "p" "''U6''" "a_punde_1a", OF z_Hos])
     assume z_Hmz:"(a_punde_1a \\in DOMAIN(pc))" (is "?z_hmz")
     assume z_Hpi:"(p=a_punde_1a)"
     assume z_Hhg:"(''U6''=?z_hbi)" (is "?z_hbo=_")
     show FALSE
 ...
 next
  ...
  by (rule subst [where P="(\<lambda>zenon_Vrwj. (((t[''sigma''])[(zenon_Vrwj[a_punde_1a])])~=?z_hoj))", OF z_Hn z_Hpk])
  have z_Hnv: "(?z_hnw~=((t[''sigma''])[(a_uunde_Fa[a_punde_1a])]))" (is "_~=?z_hnx")
  by (rule subst [where P="(\<lambda>zenon_Vtwj. (?z_hnw~=((t[''sigma''])[(zenon_Vtwj[a_punde_1a])])))", OF z_Hh z_Hpl])
  have z_Hos: "((?z_heb[a_punde_1a])=?z_hbi)" (is "?z_hot=_")
  by (rule subst [where P="(\<lambda>zenon_Vxuj. ((zenon_Vxuj[a_punde_1a])=?z_hbi))", OF z_He z_Hnz])
  have z_Hoy: "(?z_heb \\in FuncSet(PROCESSES, {''0'', ''F1'', ''F2'', ''F3'', ''F4'', ''F5'', ''F6'', ''F7'', ?z_hbi, ''U1'', ''U2'', ''U3'', ''U4'', ''U5'', ''U6'', ''U7'', ''U8'', ''UR'', ''F1U1'', ''F2U1'', ''F3U1'', ''F4U1'', ''F5U1'', ''F6U1'', ''F7U1'', ''F8U1'', ''FRU1'', ''F1U2'', ''F2U2'', ''F3U2'', ''F4U2'', ''F5U2'', ''F6U2'', ''F7U2'', ''F8U2'', ''FRU2'', ''F1U7'', ''F2U7'', ''F3U7'', ''F4U7'', ''F5U7'', ''F6U7'', ''F7U7'', ''F8U7'', ''FRU7'', ''F1U8'', ''F2U8'', ''F3U8'', ''F4U8'', ''F5U8'', ''F6U8'', ''F7U8'', ''F8U8'', ''FRU8''}))" (is "?z_hoy")
  by (rule subst [where P="(\<lambda>zenon_Vbwj. (zenon_Vbwj \\in FuncSet(PROCESSES, {''0'', ''F1'', ''F2'', ''F3'', ''F4'', ''F5'', ''F6'', ''F7'', ?z_hbi, ''U1'', ''U2'', ''U3'', ''U4'', ''U5'', ''U6'', ''U7'', ''U8'', ''UR'', ''F1U1'', ''F2U1'', ''F3U1'', ''F4U1'', ''F5U1'', ''F6U1'', ''F7U1'', ''F8U1'', ''FRU1'', ''F1U2'', ''F2U2'', ''F3U2'', ''F4U2'', ''F5U2'', ''F6U2'', ''F7U2'', ''F8U2'', ''FRU2'', ''F1U7'', ''F2U7'', ''F3U7'', ''F4U7'', ''F5U7'', ''F6U7'', ''F7U7'', ''F8U7'', ''FRU7'', ''F1U8'', ''F2U8'', ''F3U8'', ''F4U8'', ''F5U8'', ''F6U8'', ''F7U8'', ''F8U8'', ''FRU8''})))", OF z_He z_Hv])
